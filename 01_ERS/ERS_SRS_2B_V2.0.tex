...
\begin{document}
	...
	\begin{titlepage}
		...
		{\small\textbf{Repositorio GitHub:}\\
			\url{https://github.com/gleiston-guerrero/MediCita_ISR401/tree/main}}\\[1.5cm]
	...
	\begin{center}
		\url{https://github.com/gleiston-guerrero/MediCita_ISR401}
	\end{center}
	...
	Para que esta determinación quede especificada con el mismo rigor exigido a los cinco requisitos siguientes (RNF-18 a RNF-22), y no solo como una justificación en prosa, se documenta como ficha de determinación de aplicabilidad:
	...
	\begin{longtable}{p{0.28\textwidth} p{0.67\textwidth}}
		...
		Identificador & FDA-01 --- Ficha de Determinación de Aplicabilidad \\
		Requisito evaluado & Asignación o recomendación automática de cita (exigido por la Sección 5.2 de la Guía de Desarrollo del 02/09/2026 para todo componente de IA) \\
		Funcionalidad candidata & RF-02 --- Agendar cita médica; RF-13 --- Consultar disponibilidad de horarios \\
		Criterio de aplicabilidad & Un requisito de IA aplica cuando la funcionalidad candidata usa un modelo entrenado, una función de ranking/optimización o cualquier salida no determinista para decidir qué opción presentar o priorizar al usuario \\
		Evidencia técnica & RF-02/RF-13 implementan selección manual del área médica y horario por el paciente; ante falta de cupo, el sistema devuelve las próximas fechas disponibles ordenadas cronológicamente (orden fijo, sin modelo ni score de prioridad). Verificado sobre \texttt{05\_MVP/script.js} y confirmado en la comprobación técnica de RF-02/RF-13 (Sección 4, cobertura de RF Must) \\
		Determinación & No aplica: RF-02/RF-13 no incorporan ningún componente de IA/AA; se excluyen del alcance de RNF-18 a RNF-22 por no cumplir el criterio de aplicabilidad anterior \\
		Responsable de la determinación & Equipo de desarrollo (revisión técnica del código fuente citado como evidencia) \\
		Fecha de determinación & 12/09/2026 \\
		Vigencia y revisión & Esta determinación se revisa si RF-02/RF-13 incorporan en el futuro un componente de recomendación no determinista; hasta entonces permanece vigente sin necesidad de nueva medición \\
		\bottomrule
	\end{longtable}
	...
	\begin{longtable}{p{0.025\textwidth} p{0.075\textwidth} p{0.12\textwidth} p{0.10\textwidth} p{0.09\textwidth} p{0.065\textwidth} p{0.075\textwidth} p{0.075\textwidth} p{0.085\textwidth} p{0.14\textwidth} p{0.10\textwidth}}
		...
		75 & No aplica & Determinación de no aplicabilidad — asignación o recomendación automática de cita & Paciente & EV-01 & FDA-01 & No aplica — RF-02/RF-13 son deterministas sin componente de IA & No aplica — no es RNF activo & Ficha FDA-01 (ERS Sección 3.4.1) & COMP-Agendamiento (RF-02/RF-13) & MU-01 \\
		\bottomrule
	\end{longtable}
	\endgroup
	...
	\begin{longtable}{p{0.30\textwidth} p{0.67\textwidth} }
		...
		Lugar & Centro Médico Municipal Piloto \\
	...
	\begin{longtable}{p{0.25\textwidth} p{0.70\textwidth} }
		...
		Fecha / hora / lugar & 05/06/2026, 10:00--11:30, Centro Médico Municipal Piloto \\
