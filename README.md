...
**Etiqueta de línea base vigente:** `cierre-examen-suspenso-20260916`, anotada sobre el commit final del examen suspenso (16/09/2026), tras cerrar §2 (CHANGELOG), §3 (`evidencia-restringida-v1` anotada) y §15 (declaración de notas de campo e inventario EXIF completo). `cierre-examen-suspenso-20260915` y `vFinal` se conservan como referencia histórica de los dos intentos de cierre anteriores; las demás etiquetas (`evidencia-restringida-v1`, etc.) corresponden a releases de evidencia distintos y tampoco son la línea base.
