...
**Etiqueta de línea base vigente:** `cierre-examen-suspenso-20260917b`, anotada sobre el commit final del tercer cierre correctivo (17/09/2026), que incluye la recompilación del manuscrito (§16) y la limpieza del CHANGELOG (§2) posteriores a `cierre-examen-suspenso-20260917`. `cierre-examen-suspenso-20260917`, `cierre-examen-suspenso-20260916`, `cierre-examen-suspenso-20260915` y `vFinal` se conservan como referencia histórica de los intentos de cierre anteriores; las demás etiquetas (`evidencia-restringida-v1`, etc.) corresponden a releases de evidencia distintos y tampoco son la línea base.
