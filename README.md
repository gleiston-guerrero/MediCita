...
**Etiqueta de línea base vigente:** `cierre-examen-suspenso-20260917`, anotada sobre el commit final del segundo cierre correctivo (17/09/2026), tras corregir §2 (CHANGELOG, atribuciones y línea base declarada), §3 (esta misma declaración), §12 (manifiesto `checksums_datos.sha256` regenerado y `run_all.py` corregido), §15 (atribución de V09) y §16. `cierre-examen-suspenso-20260916`, `cierre-examen-suspenso-20260915` y `vFinal` se conservan como referencia histórica de los intentos de cierre anteriores; las demás etiquetas (`evidencia-restringida-v1`, etc.) corresponden a releases de evidencia distintos y tampoco son la línea base.
