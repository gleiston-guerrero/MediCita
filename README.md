...
**Etiqueta de línea base vigente:** `cierre-examen-suspenso-20260917d`, anotada sobre el commit final del cuarto cierre correctivo (17/09/2026), que sincroniza este README, el CHANGELOG (`[4.3.5]`) y la retrospectiva (`10_Autoria/retrospectiva_equipo.md`) para que los tres declaren la misma etiqueta como línea base — inconsistencia detectada dos veces seguidas en los cierres correctivos anteriores. `cierre-examen-suspenso-20260917c`, `cierre-examen-suspenso-20260917`, `cierre-examen-suspenso-20260916`, `cierre-examen-suspenso-20260915` y `vFinal` se conservan como referencia histórica de los intentos de cierre anteriores; las demás etiquetas (`evidencia-restringida-v1`, etc.) corresponden a releases de evidencia distintos y tampoco son la línea base.
