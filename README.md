...
**Etiqueta de línea base vigente:** `cierre-examen-suspenso-20260917g`, anotada sobre el commit de esta entrada (que corrige, en README/CHANGELOG/retrospectiva, la afirmación falsa de que `cierre-examen-suspenso-20260917e` existía). `cierre-examen-suspenso-20260917f`, `cierre-examen-suspenso-20260917d`, `cierre-examen-suspenso-20260917c`, `cierre-examen-suspenso-20260917`, `cierre-examen-suspenso-20260916`, `cierre-examen-suspenso-20260915` y `vFinal` se conservan como referencia histórica de los intentos de cierre anteriores, **verificadas con `git ls-remote --tags` contra el repositorio remoto** — `cierre-examen-suspenso-20260917e` se planeó en el CHANGELOG `[4.3.7]` pero nunca se publicó (no existe en el remoto) y no debe citarse como línea base histórica; las demás etiquetas (`evidencia-restringida-v1`, etc.) corresponden a releases de evidencia distintos y tampoco son la línea base.
