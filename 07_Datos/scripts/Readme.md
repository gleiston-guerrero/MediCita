...
| Archivo | Descripción |
|---|---|
| `run_all.py` | Script único que ejecuta `06_Experimento/scripts_analisis/run_all.py` y sincroniza sus salidas hacia `07_Datos/datos_procesados/` y `07_Datos/resultados/`. |
