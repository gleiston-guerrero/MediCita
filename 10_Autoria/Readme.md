...
| A11 | [`exif_inventario.csv`](exif_inventario.csv) | 🟢 Completo | 34 de 34 elementos del expediente (29 fotografías y 5 capturas de pantalla)(Fotos_Entorno, Fotos_Aplicacion, Fotos_equipos, correspondencia/evidencia_entrevista), con EXIF real, inferido por contexto, o marcado explícitamente `SIN_EXIF` cuando no aplica (p. ej. capturas de pantalla o fotos sin metadato tras compartirse por WhatsApp). |
